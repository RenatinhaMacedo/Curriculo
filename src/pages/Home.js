    ...
    return (
        <View style={estilo.container}>
            <View style={estilo.imagemContainer}>
                <Image source={require('./images/gata.jpg')} style={{ width: 175, height: 175, borderRadius: 100 }} />
            </View>
            ...
            <View style={estilo.textoContainer}>
                ...
                <Text style={estilo.texto}>
                    meu nome é <Text style={estilo.destaque}>Renata Macedo</Text> e este é o meu currículo.
                </Text>
            </View>
